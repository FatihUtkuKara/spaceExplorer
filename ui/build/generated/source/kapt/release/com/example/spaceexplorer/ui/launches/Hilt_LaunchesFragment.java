...
public abstract class Hilt_LaunchesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LaunchesFragment() {
    super();
  }

  Hilt_LaunchesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LaunchesFragment_GeneratedInjector) this.generatedComponent()).injectLaunchesFragment(UnsafeCasts.<LaunchesFragment>unsafeCast(this));
    }
  }
